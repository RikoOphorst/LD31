var EnemyOil = function (x, y) 
{
    this._quad2d = Quad2D.new();

    extend(this, this._quad2d);

    this.setTexture("textures/characters/oil_walk.png");
    this.setToTexture();
    ...
    this._tooltip = new Tooltip(this, "Left click to attack [colour=FF0000]Iron Golem[/colour]", 30, 30, 29, 0.8);
    ...
    this.update = function (dt, target, enemies, loot)
    {
        ...
        if (Math.max(x1, x2) - Math.min(x1, x2) > tSize.w / 2)
        {
            ...
            this.setRotation(0,0,Math.sin(this._wobble)/45);
        }
    ...
    this.playAttack = function ()
    {
        ...
        {
            this.setTexture("textures/characters/oil_attack.png");
            this._currentAnimation.stop();
